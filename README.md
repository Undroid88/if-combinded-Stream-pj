...
## 🧪 Testing Section:
I used two types of testing to make sure everything worked properly - manual testing through the Streamlit interface, and automated testing for logic functions. The structure of the project, with logic kept separate from the GUI, made it possible to test functional correctness independently from the interface. Two types of testing were performed: manual testing and automated unit testing using pytest.
**For example:**
...
Overall, by the end of this project i felt more confident using Streamlit, structuring Python coding properly and writing tests. It demonstrated how a simple quiz can support organisational learning while reinforcing essential development skills.
